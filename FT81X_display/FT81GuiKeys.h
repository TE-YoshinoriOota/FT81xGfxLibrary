#ifndef FT81GUIKEY_HEADER_GUARD
#define FT81GUIKEY_HEADER_GUARD
...
class FT81xGuiKeys : public FT81xGuiComponent {
public:
  virtual ~FT81xGuiKeys();
  virtual void draw();
...
protected:
  ...
  FT81xGuiKeys(RegisterOperation *reg, CommandOperation *cmd, FT81xDisplay *disp);
